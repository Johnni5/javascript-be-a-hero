...
const appSettings = {
    databaseURL: "https://be-a-hero-b1334-default-rtdb.europe-west1.firebasedatabase.app/"
}


const app = initializeApp(appSettings)
const database = getDatabase(app)
const shoppingListInDB = ref(database, "endorsments")
...
function appendItemToCartEl(param) {
  ...
  newEl.addEventListener("click", function() {
    ...
    let exactLocOfItem = ref(database, `endorsments/${itemId}`);
